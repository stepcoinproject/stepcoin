...
public:
    ...
    unsigned int StakeTimestampMask() const { return nStakeTimestampMask; }
    int64_t LaunchTime() const { return nLaunchTime; }
    int64_t PoWReward() const { return nPoWReward; }
    ...
    inline int TargetTimespan() const { return nTargetTimespan; }
...
protected:
    ...
    unsigned int nStakeTimestampMask;
