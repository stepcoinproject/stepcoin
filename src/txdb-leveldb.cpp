...
bool CTxDB::LoadBlockIndex()
{
    ...
    LogPrintf("LoadBlockIndex(): hashBestChain=%s  height=%d  tx=%lu  trust=%s  date=%s\n",
      hashBestChain.ToString(), nBestHeight, (unsigned long)pindexBest->nChainTx, CBigNum(nBestChainTrust).ToString(),
